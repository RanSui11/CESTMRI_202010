...
%
% Please contact Lin Chen at chenlin0430@gmail.com if you have any questions about the code. 
...
%-------------background fitting --------------%
%X1-4: Zero to third order parameters D0-D3
...
%-------------CEST peak fitting --------------%
%X1: Rexch, X2:Lorienten line width; X(3) is the offset.
%X4-7: The background parameters from D0-D3
